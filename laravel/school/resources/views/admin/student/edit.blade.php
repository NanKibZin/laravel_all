              ...
              <div class="col-md-12">
                  <div class="card card-primary">
                    ...
                    @endif
                      ...
                      <form method="POST" action="{{ route('stu.update', $student->id) }}" enctype="multipart/form-data">
                        @csrf
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                        <input type="hidden" name="id" value="{{ $student->id }}">
                                          ...
                                          <input type="text" name="first_name" class="form-control" id="first_name" placeholder="First Name" value="{{ old('name', $student->name) }}">
                                      </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          @if($student->profile_pic)
                                              <div class="mt-2">
                                                  <img src="{{ asset('storage/'.$student->profile_pic) }}" alt="Profile Picture" width="100">
                                              </div>
                                          @endif
                                      </div>
                                  </div>
