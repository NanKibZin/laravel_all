            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a class=" btn btn-primary" href="{{ route('cs.index') }}">Add Class & Subject</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('cs.list') }}" method="GET">
                            <div class="form-row align-items-end">
                                ...
                                <div class="form-group col-md-3 d-flex">
                                    ...
                                    <a href="{{ route('cs.list') }}" class="btn btn-success">Reset</a>
                                </div>
                            </div>
                        </form>
        ...
        @else
           ...
           @endif
                                        ...
                                        <td>
                                            <a href="{{ route('cs.edit',$item->id) }}" class="btn btn-sm btn-success">Edit</a>
                                            <a href="{{ route('cs.delete',$item->id) }}" onclick="return confirm('Are you sure you want to delete this?')" class="btn btn-sm btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
