                          ...
                          <table id="example1" class="table table-bordered table-striped">
                              ...
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('academic-year.edit',$item->id) }}" class="btn btn-success">Edit</a></td>
                                    <td><a href="{{ route('academic-year.delete',$item->id) }}" onclick="confirm('Are you sure you want to delete this?')" class="btn btn-danger">Delete</a></td>
                                </tr>
                            @endforeach
